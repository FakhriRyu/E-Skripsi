    ...
    <div class="flex space-x-9">
        ...
        <div class="w-full max-w-md bg-white shadow-md p-4">
            ...
            <div class="mb-4">
                ...
                <input type="text" class="block py-2.5 px-0 w-full text-sm text-gray-900 bg-transparent border-0 border-b-2 border-gray-300 appearance-none dark:text-white dark:border-gray-600 dark:focus:border-blue-500 focus:outline-none focus:ring-0 focus:border-blue-600 peer" value="{{ \Carbon\Carbon::parse($bimbingan->waktu2)->locale('id_ID')->isoFormat('dddd, D MMMM YYYY H:mm') ?: 'belum dikonfirmasi' }}" readonly>
            </div>
            <div class="mb-4">
